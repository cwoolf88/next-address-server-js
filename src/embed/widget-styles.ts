...
.na-widget__link-status-slot .na-widget__link-status {
  width: 100%;
  height: 100%;
}
.na-widget__title {
...
.na-widget__link-status--linked {
  color: var(--na-badge-success-bg);
  background: var(--na-badge-success-text);
  box-shadow: inset 0 0 0 1px var(--na-badge-success-text);
}
.na-widget__link-status--unlinked {
  color: var(--na-badge-muted-bg);
  background: var(--na-badge-muted-text);
  box-shadow: inset 0 0 0 1px var(--na-badge-muted-text);
  opacity: 0.5;
}
.na-widget__link-status--linked .na-widget__link-status-icon,
.na-widget__link-status--unlinked .na-widget__link-status-icon {
  width: 1rem;
  height: 1rem;
}
.na-widget__link-status--loading {
  background: var(--na-badge-muted-bg);
  box-shadow: none;
  overflow: hidden;
}
.na-widget__link-status-icon {
  display: block;
  width: 1.75rem;
  height: 1.75rem;
  flex-shrink: 0;
}
.na-widget__link-status--loading .na-widget__link-status-icon {
  display: block;
  width: 100%;
  height: 100%;
  overflow: hidden;
}
.na-widget__link-status--loading .na-widget__link-status-ripples {
  color: var(--na-btn-primary-bg);
}
.na-widget__link-status--loading .na-widget__link-status-ripple-hub {
  fill: var(--na-btn-primary-bg);
  opacity: 0.55;
}
.na-widget__link-status--loading .na-widget__link-status-ripple {
  fill: none;
  stroke: currentColor;
  stroke-width: 2.75;
}
.na-widget__link-status[data-na-tooltip]::after {
...
.na-widget__link-status:hover::after,
.na-widget__link-status:focus-visible::after {
  opacity: 1;
}
